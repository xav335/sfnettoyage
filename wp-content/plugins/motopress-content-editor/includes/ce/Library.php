...
*/
        ...
        $postsGridObj = new MPCEObject(MPCEShortcode::PREFIX . 'posts_grid', $motopressCELang->CEPostsGridObjName, 'posts-grid.png', array(
            ...
            'pagination' => array(
                'type' => 'checkbox',
                'label' => $motopressCELang->CEPostsGridObjPaginationLabel,
                'default' => 'false',
                'dependency' => array(
                    'parameter' => 'load_more_btn',
                    'value' => 'false'
                )
            ),
            'load_more_btn' => array(
                'type' => 'checkbox',
                'label' => $motopressCELang->CEPostsGridObjLoadMoreBtnLabel,
                'description' => $motopressCELang->CEPostsGridObjLoadMoreBtnDesc,
                'default' => 'false'
            ),
...
//                    'medium' => $motopressCELang->CEMedium,
            ...
            'text' => array(
                ...
                'default' => 'Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.',
                'text' => $motopressCELang->CEOpenInWPEditor,
                'saveInContent' => 'true'
            ),
            'button_show' => array(
